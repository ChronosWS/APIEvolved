                    ...
                    RCON.Command("listplayers", function(res) {
                        if(res.status && res.message && res.message != "No Players Connected") {
                            ...
                            for(var p in data.players) {
                                data.players[p].characterName = entities.encode(data.players[p].characterName);
                                data.players[p].steamName = entities.encode(data.players[p].steamName);
                                if(data.tribe) data.players[p].tribe.name = entities.encode(data.players[p].tribe.name);
                            }
